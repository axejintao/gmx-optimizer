...
import "@badger-finance/contracts/lib/SettAccessControl.sol";

import {IVault} from "@badger-finance/interfaces/badger/IVault.sol";
import {IStrategy} from "@badger-finance/interfaces/badger/IStrategy.sol";
import {IERC20Detailed} from "@badger-finance/interfaces/erc20/IERC20Detailed.sol";
import {BadgerGuestListAPI} from "@badger-finance/interfaces/yearn/BadgerGuestlistApi.sol";
...
contract Vault is ERC20Upgradeable, SettAccessControl, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    address public treasury; // set by governance @badger-finance. any fees go there
    ...
    /// @param _recipient Address to issue the Sett shares to.
    /// @param _amount Quantity of tokens to deposit.
    function _depositFor(address _recipient, uint256 _amount) internal virtual nonReentrant {
    ...
    /// @param _shares Quantity of shares to redeem.
    function _withdraw(uint256 _shares) internal virtual nonReentrant {
